...
const WalkAndEarn = () => {
  return (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-3xl p-8 text-white shadow-xl shadow-orange-500/20 relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-3xl font-bold mb-2">Walk & Earn Rewards</h2>
          <p className="text-orange-100 mb-6">Convert your daily steps into Healance Coins and redeem exciting vouchers.</p>
          <div className="flex items-center gap-4">
            <div className="bg-white/20 backdrop-blur-md p-4 rounded-2xl flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">450 Coins</p>
              </div>
            </div>
        ...
        <Footprints className="absolute -bottom-10 -right-10 w-64 h-64 text-white/10 rotate-12" />
      </div>
          ...
          <div className="flex items-center justify-center py-6">
            <div className="relative w-40 h-40">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-3xl font-bold text-slate-900">6,240</span>
                <span className="text-xs text-slate-500">steps</span>
              </div>
            </div>
          </div>
          <p className="text-center text-sm text-slate-600">3,760 steps to reach daily goal</p>
        </div>

        <div className="md:col-span-2 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <h3 className="font-bold text-slate-800 mb-4">Rewards Store</h3>
